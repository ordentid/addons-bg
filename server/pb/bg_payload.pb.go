...
var file_bg_payload_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x22, 0x16, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x54, 0x68, 0x69, 0x72, 0x64, 0x50, 0x61,
	...
	0x64, 0x61, 0x74, 0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x62, 0x67, 0x2e,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x52,
	0x04, 0x64, 0x61, 0x74, 0x61, 0x2a, 0x7d, 0x0a, 0x0a, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x74, 0x61,
	...
	0x70, 0x6c, 0x69, 0x63, 0x61, 0x6e, 0x74, 0x10, 0x00, 0x12, 0x14, 0x0a, 0x10, 0x43, 0x6f, 0x6d,
	0x70, 0x61, 0x6e, 0x79, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x6e, 0x74, 0x10, 0x01, 0x2a,
...
var file_bg_payload_proto_depIdxs = []int32{
	...
	72, // 4: bg.service.v1.Transaction.transactionTypeID:type_name -> bg.service.v1.BgType
	6,  // 5: bg.service.v1.TaskMappingData.task:type_name -> bg.service.v1.Task
	7,  // 6: bg.service.v1.TaskMappingData.company:type_name -> bg.service.v1.Company
	12, // 7: bg.service.v1.TaskMappingData.data:type_name -> bg.service.v1.MappingData
	6,  // 8: bg.service.v1.TaskMappingDigitalData.task:type_name -> bg.service.v1.Task
	7,  // 9: bg.service.v1.TaskMappingDigitalData.company:type_name -> bg.service.v1.Company
	14, // 10: bg.service.v1.TaskMappingDigitalData.data:type_name -> bg.service.v1.MappingDigitalData
	6,  // 11: bg.service.v1.TaskIssuingData.task:type_name -> bg.service.v1.Task
	7,  // 12: bg.service.v1.TaskIssuingData.company:type_name -> bg.service.v1.Company
	17, // 13: bg.service.v1.TaskIssuingData.data:type_name -> bg.service.v1.IssuingData
	18, // 14: bg.service.v1.IssuingData.publishing:type_name -> bg.service.v1.PublishingData
	19, // 15: bg.service.v1.IssuingData.account:type_name -> bg.service.v1.AccountData
	20, // 16: bg.service.v1.IssuingData.applicant:type_name -> bg.service.v1.ApplicantData
	21, // 17: bg.service.v1.IssuingData.project:type_name -> bg.service.v1.ProjectData
	22, // 18: bg.service.v1.IssuingData.document:type_name -> bg.service.v1.DocumentData
	2,  // 19: bg.service.v1.PublishingData.applicantType:type_name -> bg.service.v1.ApplicantType
	3,  // 20: bg.service.v1.PublishingData.publishingType:type_name -> bg.service.v1.PublishingType
	72, // 21: bg.service.v1.PublishingData.bgType:type_name -> bg.service.v1.BgType
	4,  // 22: bg.service.v1.ApplicantData.gender:type_name -> bg.service.v1.Gender
	26, // 23: bg.service.v1.GetBeneficiaryNameResponse.data:type_name -> bg.service.v1.BeneficiaryName
	29, // 24: bg.service.v1.GetApplicantNameResponse.data:type_name -> bg.service.v1.ApplicantName
	8,  // 25: bg.service.v1.GetThirdPartyResponse.data:type_name -> bg.service.v1.ThirdParty
	7,  // 26: bg.service.v1.GetTaskMappingFilterCompanyResponse.data:type_name -> bg.service.v1.Company
	0,  // 27: bg.service.v1.GetTaskMappingFileRequest.status:type_name -> bg.service.v1.TaskStatus
	1,  // 28: bg.service.v1.GetTaskMappingFileRequest.step:type_name -> bg.service.v1.TaskStep
	73, // 29: bg.service.v1.GetTaskMappingFileRequest.dir:type_name -> bg.service.v1.Direction
	5,  // 30: bg.service.v1.GetTaskMappingFileRequest.fileFormat:type_name -> bg.service.v1.FormatTemplate
	0,  // 31: bg.service.v1.GetTaskMappingRequest.status:type_name -> bg.service.v1.TaskStatus
	1,  // 32: bg.service.v1.GetTaskMappingRequest.step:type_name -> bg.service.v1.TaskStep
	73, // 33: bg.service.v1.GetTaskMappingRequest.dir:type_name -> bg.service.v1.Direction
	11, // 34: bg.service.v1.GetTaskMappingResponse.data:type_name -> bg.service.v1.TaskMappingData
	74, // 35: bg.service.v1.GetTaskMappingResponse.pagination:type_name -> bg.service.v1.PaginationResponse
	11, // 36: bg.service.v1.GetTaskMappingDetailResponse.data:type_name -> bg.service.v1.TaskMappingData
	12, // 37: bg.service.v1.CreateTaskMappingRequest.data:type_name -> bg.service.v1.MappingData
	6,  // 38: bg.service.v1.CreateTaskMappingResponse.data:type_name -> bg.service.v1.Task
	0,  // 39: bg.service.v1.GetTaskMappingDigitalFileRequest.status:type_name -> bg.service.v1.TaskStatus
	1,  // 40: bg.service.v1.GetTaskMappingDigitalFileRequest.step:type_name -> bg.service.v1.TaskStep
	73, // 41: bg.service.v1.GetTaskMappingDigitalFileRequest.dir:type_name -> bg.service.v1.Direction
	5,  // 42: bg.service.v1.GetTaskMappingDigitalFileRequest.fileFormat:type_name -> bg.service.v1.FormatTemplate
	0,  // 43: bg.service.v1.GetTaskMappingDigitalRequest.status:type_name -> bg.service.v1.TaskStatus
	1,  // 44: bg.service.v1.GetTaskMappingDigitalRequest.step:type_name -> bg.service.v1.TaskStep
	73, // 45: bg.service.v1.GetTaskMappingDigitalRequest.dir:type_name -> bg.service.v1.Direction
	13, // 46: bg.service.v1.GetTaskMappingDigitalResponse.data:type_name -> bg.service.v1.TaskMappingDigitalData
	74, // 47: bg.service.v1.GetTaskMappingDigitalResponse.pagination:type_name -> bg.service.v1.PaginationResponse
	13, // 48: bg.service.v1.GetTaskMappingDigitalDetailResponse.data:type_name -> bg.service.v1.TaskMappingDigitalData
	15, // 49: bg.service.v1.CreateTaskMappingDigitalRequest.beneficiary:type_name -> bg.service.v1.Beneficiary
	6,  // 50: bg.service.v1.CreateTaskMappingDigitalResponse.data:type_name -> bg.service.v1.Task
	73, // 51: bg.service.v1.GetTransactionFileRequest.dir:type_name -> bg.service.v1.Direction
	5,  // 52: bg.service.v1.GetTransactionFileRequest.fileFormat:type_name -> bg.service.v1.FormatTemplate
	10, // 53: bg.service.v1.GetTransactionRequest.transaction:type_name -> bg.service.v1.TransactionRequest
	73, // 54: bg.service.v1.GetTransactionRequest.dir:type_name -> bg.service.v1.Direction
	9,  // 55: bg.service.v1.GetTransactionResponse.data:type_name -> bg.service.v1.Transaction
	74, // 56: bg.service.v1.GetTransactionResponse.pagination:type_name -> bg.service.v1.PaginationResponse
	9,  // 57: bg.service.v1.GetTransactionDetailResponse.data:type_name -> bg.service.v1.Transaction
	75, // 58: bg.service.v1.CreateTransactionResponse.data:type_name -> bg.service.v1.Mapping
	9,  // 59: bg.service.v1.UpdateTransactionRequest.data:type_name -> bg.service.v1.Transaction
	9,  // 60: bg.service.v1.UpdateTransactionResponse.data:type_name -> bg.service.v1.Transaction
	0,  // 61: bg.service.v1.GetTaskIssuingRequest.status:type_name -> bg.service.v1.TaskStatus
	1,  // 62: bg.service.v1.GetTaskIssuingRequest.step:type_name -> bg.service.v1.TaskStep
	73, // 63: bg.service.v1.GetTaskIssuingRequest.dir:type_name -> bg.service.v1.Direction
	16, // 64: bg.service.v1.GetTaskIssuingResponse.data:type_name -> bg.service.v1.TaskIssuingData
	74, // 65: bg.service.v1.GetTaskIssuingResponse.pagination:type_name -> bg.service.v1.PaginationResponse
	16, // 66: bg.service.v1.GetTaskIssuingDetailResponse.data:type_name -> bg.service.v1.TaskIssuingData
	17, // 67: bg.service.v1.CreateTaskIssuingRequest.data:type_name -> bg.service.v1.IssuingData
	6,  // 68: bg.service.v1.CreateTaskIssuingResponse.data:type_name -> bg.service.v1.Task

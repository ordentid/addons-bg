...
type PublishingData struct {
	...
	OpeningBranchId      uint64         `protobuf:"varint,11,opt,name=openingBranchId,proto3" json:"openingBranchId,omitempty"`
	OpeningBranchName    string         `protobuf:"bytes,12,opt,name=openingBranchName,proto3" json:"openingBranchName,omitempty"`
	PublishingBranchId   uint64         `protobuf:"varint,13,opt,name=publishingBranchId,proto3" json:"publishingBranchId,omitempty"`
...
func (x *PublishingData) GetOpeningBranchId() uint64 {
	if x != nil {
...
func (x *PublishingData) GetPublishingBranchId() uint64 {
	if x != nil {
...
var file_bg_payload_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x63, 0x68, 0x49, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0f, 0x6f, 0x70,
	...
	0x61, 0x6e, 0x63, 0x68, 0x49, 0x64, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x04, 0x52, 0x12, 0x70, 0x75,

...
var _regex_ApplicantData_NpwpNo = regexp.MustCompile(`^[0-9]{16}$`)
...
var _regex_ApplicantData_Nik = regexp.MustCompile(`^[0-9]{16}$`)
...
func (this *ApplicantData) Validate() error {
	...
	if !_regex_ApplicantData_NpwpNo.MatchString(this.NpwpNo) {
		return github_com_mwitkow_go_proto_validators.FieldError("NpwpNo", fmt.Errorf(`value '%v' must be a string conforming to regex "^[0-9]{16}$"`, this.NpwpNo))
	}

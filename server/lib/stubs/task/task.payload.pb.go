...
var file_task_payload_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x22, 0x83, 0x0b, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x61, 0x73, 0x6b, 0x52,
	...
	0x6d, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x69, 0x73, 0x74, 0x69, 0x6e,
	0x63, 0x74, 0x4b, 0x65, 0x79, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x64, 0x69, 0x73,
	0x74, 0x69, 0x6e, 0x63, 0x74, 0x4b, 0x65, 0x79, 0x22, 0x1e, 0x0a, 0x09, 0x64, 0x69, 0x72, 0x65,
...
var file_task_payload_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_task_payload_proto_goTypes = []interface{}{
	...
	(*ListTaskPluckRequest)(nil),          // 13: task.service.v1.ListTaskPluckRequest
	(*ListTaskPluckResponse)(nil),         // 14: task.service.v1.ListTaskPluckResponse
	(*Pagination)(nil),                    // 15: task.service.v1.Pagination
	(*PaginationResponse)(nil),            // 16: task.service.v1.PaginationResponse
	(*Sort)(nil),                          // 17: task.service.v1.Sort
	(*Search)(nil),                        // 18: task.service.v1.Search
	(*ListTaskResponse)(nil),              // 19: task.service.v1.ListTaskResponse
	(*GraphStatusRequest)(nil),            // 20: task.service.v1.GraphStatusRequest
	(*GraphStatusColumnTypeRequest)(nil),  // 21: task.service.v1.GraphStatusColumnTypeRequest
	(*GraphStatusColumnTypeResponse)(nil), // 22: task.service.v1.GraphStatusColumnTypeResponse
	(*GraphStatusColumnType)(nil),         // 23: task.service.v1.GraphStatusColumnType
	(*GraphStatus)(nil),                   // 24: task.service.v1.GraphStatus
	(*GraphStatusResponse)(nil),           // 25: task.service.v1.GraphStatusResponse
	(*GraphStepRequest)(nil),              // 26: task.service.v1.GraphStepRequest
	(*GraphStep)(nil),                     // 27: task.service.v1.GraphStep
	(*GraphStepResponse)(nil),             // 28: task.service.v1.GraphStepResponse
	(*AssignaTypeIDRequest)(nil),          // 29: task.service.v1.AssignaTypeIDRequest
	(*AssignaTypeIDResponse)(nil),         // 30: task.service.v1.AssignaTypeIDResponse
	(*GetTaskByTypeIDReq)(nil),            // 31: task.service.v1.GetTaskByTypeIDReq
	(*GetTaskByTypeIDRes)(nil),            // 32: task.service.v1.GetTaskByTypeIDRes
	(*RejectBySystemReq)(nil),             // 33: task.service.v1.RejectBySystemReq
	(*RejectBySystemRes)(nil),             // 34: task.service.v1.RejectBySystemRes
	(*GetTaskByIDReq)(nil),                // 35: task.service.v1.GetTaskByIDReq
	(*GetTaskByIDRes)(nil),                // 36: task.service.v1.GetTaskByIDRes
	(*Task)(nil),                          // 37: task.service.v1.Task
	(structpb.NullValue)(0),               // 38: google.protobuf.NullValue
	(Statuses)(0),                         // 39: task.service.v1.statuses
	(Steps)(0),                            // 40: task.service.v1.steps
}
var file_task_payload_proto_depIdxs = []int32{
	37, // 0: task.service.v1.SaveTaskRequest.task:type_name -> task.service.v1.Task
	37, // 1: task.service.v1.SaveTaskResponse.data:type_name -> task.service.v1.Task
	38, // 2: task.service.v1.errorBodyResponse.data:type_name -> google.protobuf.NullValue
	37, // 3: task.service.v1.SetTaskResponse.data:type_name -> task.service.v1.Task
	37, // 4: task.service.v1.ListTaskRequest.task:type_name -> task.service.v1.Task
	0,  // 5: task.service.v1.ListTaskRequest.dir:type_name -> task.service.v1.ListTaskRequest.direction
	37, // 6: task.service.v1.ListTaskPluckRequest.task:type_name -> task.service.v1.Task
	37, // 7: task.service.v1.ListTaskResponse.data:type_name -> task.service.v1.Task
	16, // 8: task.service.v1.ListTaskResponse.pagination:type_name -> task.service.v1.PaginationResponse
	39, // 9: task.service.v1.GraphStatusRequest.status:type_name -> task.service.v1.statuses
	39, // 10: task.service.v1.GraphStatusColumnTypeRequest.status:type_name -> task.service.v1.statuses
	23, // 11: task.service.v1.GraphStatusColumnTypeResponse.data:type_name -> task.service.v1.GraphStatusColumnType
	39, // 12: task.service.v1.GraphStatus.status:type_name -> task.service.v1.statuses
	24, // 13: task.service.v1.GraphStatusResponse.data:type_name -> task.service.v1.GraphStatus
	40, // 14: task.service.v1.GraphStepRequest.step:type_name -> task.service.v1.steps
	39, // 15: task.service.v1.GraphStepRequest.status:type_name -> task.service.v1.statuses
	40, // 16: task.service.v1.GraphStep.step:type_name -> task.service.v1.steps
	27, // 17: task.service.v1.GraphStepResponse.data:type_name -> task.service.v1.GraphStep
	37, // 18: task.service.v1.GetTaskByTypeIDRes.data:type_name -> task.service.v1.Task
	39, // 19: task.service.v1.RejectBySystemReq.status:type_name -> task.service.v1.statuses
	37, // 20: task.service.v1.GetTaskByIDRes.data:type_name -> task.service.v1.Task

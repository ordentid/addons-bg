...
type ApiServiceClient interface {
	...
	BRICaMSgetCustomerV2Http(ctx context.Context, in *BricamsGetCustomerReq, opts ...grpc.CallOption) (*BRICaMSSvcMultipleResV2, error)
...
func (c *apiServiceClient) BRICaMSgetCustomerV2Http(ctx context.Context, in *BricamsGetCustomerReq, opts ...grpc.CallOption) (*BRICaMSSvcMultipleResV2, error) {
	out := new(BRICaMSSvcMultipleResV2)
	err := c.cc.Invoke(ctx, "/company.service.v1.ApiService/BRICaMSgetCustomerV2Http", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApiServiceServer interface {
	...
	BRICaMSgetCustomerV2Http(context.Context, *BricamsGetCustomerReq) (*BRICaMSSvcMultipleResV2, error)
...
func (UnimplementedApiServiceServer) BRICaMSgetCustomerV2Http(context.Context, *BricamsGetCustomerReq) (*BRICaMSSvcMultipleResV2, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BRICaMSgetCustomerV2Http not implemented")
}
...
func _ApiService_BRICaMSgetCustomerV2Http_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BricamsGetCustomerReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiServiceServer).BRICaMSgetCustomerV2Http(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/company.service.v1.ApiService/BRICaMSgetCustomerV2Http",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServiceServer).BRICaMSgetCustomerV2Http(ctx, req.(*BricamsGetCustomerReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ApiService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BRICaMSgetCustomerV2Http",
			Handler:    _ApiService_BRICaMSgetCustomerV2Http_Handler,
		},
		{
